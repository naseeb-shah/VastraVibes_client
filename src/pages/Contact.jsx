        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={5}>
            ...
            <Box display="flex" justifyContent="center" alignItems="center" mt={2} pb={2}>
              <FaLinkedin size={50} style={{ color: "white", padding: "3px",backgroundColor:"black", borderRadius: "5px", margin: "0 8px" }} />
              <FaTwitter size={50} style={{ color: "white", padding: "3px",backgroundColor:"black", borderRadius: "5px", margin: "0 8px" }} />
              <FaInstagram size={50} style={{ color: "white",padding: "3px",backgroundColor:"black", borderRadius: "5px", margin: "0 8px" }} />
            </Box>
          </Grid>
